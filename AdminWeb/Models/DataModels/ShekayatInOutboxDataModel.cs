...
{
    public class ShekayatInOutboxDataModel
    {
    ...
    public class Shekayat
    {
        ...
        public Shekayat()
        {
            this.ShekayatInboxOutBox = new HashSet<ShekayatInOutboxDataModel>();
        }
        ...
        public virtual ICollection<ShekayatInOutboxDataModel> ShekayatInboxOutBox { get; set; }
        public string Text { get; set; }
        public string profile { get; set; }
        public string Type { get; set; }
        public int F_ShekayatID { get; set; }
        public DateTime LastUpdateOnUtc { get; set; }
        public string ShekayatInbox_brief { get; set; }
