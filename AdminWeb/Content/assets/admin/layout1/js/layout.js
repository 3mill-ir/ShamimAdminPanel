...
function handleboxedLayout() {
    ...
    if ($('body').hasClass('boxed')) {
        ...
        if (!$('body').hasClass('sidebar-top') && windowWidth > 1220)  {
            ...
            $.backstretch(["../Content/assets/global/images/gallery/bg1.jpg", "../Content/assets/global/images/gallery/bg2.jpg", "../Content/assets/global/images/gallery/bg3.jpg", "../Content/assets/global/images/gallery/bg4.jpg"],
