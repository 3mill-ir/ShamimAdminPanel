...
(function($) {
    ...
    var defaults = {
        ...
        showButtons: true,
        showLegend: true,
        nextBtn: $('<a class="next-btn sf-right sf-btn" href="#">مرحله بعد</a>'),
        prevBtn: $('<a class="prev-btn sf-left sf-btn" href="#">مرحله قبل</a>'),
        finishBtn: $('<input class="finish-btn sf-right sf-btn" type="submit" value="پایان"/>'),
