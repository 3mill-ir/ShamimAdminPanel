...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "داده ای در جدول وجود ندارد !" )
		{
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input placeholder="جستجو ..." type="search" class="'+classes.sFilterInput+'"/>';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "نمایش _START_ تا _END_ از _TOTAL_ داده پردازش شده",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "نمایش 0 تا 0 از 0 داده پردازش شده",
