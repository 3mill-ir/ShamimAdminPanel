$(function() {
    $.backstretch(["../Content/assets/global/images/gallery/login4.jpg", "../Content/assets/global/images/gallery/login3.jpg", "../Content/assets/global/images/gallery/login2.jpg", "../Content/assets/global/images/gallery/login.jpg"], {
        fade: 600,
        duration: 4000
    });
    ...
    /* Background Slide */
    $('.bg-slider').backstretch(["../Content/assets/global/images/gallery/login4.jpg", "../Content/assets/global/images/gallery/login3.jpg", "../Content/assets/global/images/gallery/login2.jpg", "../Content/assets/global/images/gallery/login.jpg"], {
        fade: 600,
        duration: 4000
    });
    ...
    $('#image-cb').change(function() {
        if ($(this).is(":checked")) {
            $.backstretch(["../Content/assets/global/images/gallery/login.jpg"], {
                fade: 600,
                duration: 4000
            });
