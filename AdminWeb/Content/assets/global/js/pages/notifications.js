...
function generate(position, container, confirm, type, style) {
    ...
    if (type == 'success') {
        ...
        MessageHeader = 'تبریک !';
        MessageContent = 'عملیات مورد نظر با موفقیت انجام شد';
    }
        //else if (type == 'info') {
        //    MessageType = 'alert-info';
        //    MessageHeader = 'اطلاع یابی';
        //    MessageContent = content;
        //}
    else if (type == 'danger') {
        MessageType = 'alert-danger';
        MessageHeader = 'خطا !';
        MessageContent = 'متاسفانه فرآیند اجام عملیات مورد نظر با خطا مواجه شده. لطفا مجددا تلاش کنید ';
    }
    else if (type == '') {
        MessageType = '';
        MessageHeader = '';
    ...
    if (container == '') {
        ...
        var n = noty({
            text: '<div class="alert ' + MessageType + ' media fade in"><p><strong>' + MessageHeader + '</strong></p><p>' + MessageContent + '</p></div>',
            type: type,
            dismissQueue: true,
            layout: position,
            closeWith: ['click'],
