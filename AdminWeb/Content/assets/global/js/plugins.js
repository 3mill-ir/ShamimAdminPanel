    ...
    if ($('.table-dynamic').length && $.fn.dataTable) {
        $('.table-dynamic').each(function () {
            ...
            if ($(this).hasClass('table-tools')) {
                ...
                opt.oTableTools = {
                    "sSwfPath": "../Content/assets/global/plugins/datatables/swf/copy_csv_xls_pdf.swf",
                ...
                $(this).DataTable( {
                    initComplete: function () {
                        ...
                        api.columns().indexes().flatten().each( function ( i ) {
                            ...
                            var select = $('<select class="form-control" data-placeholder="فیلتر ..."><option value=""></option></select>')
